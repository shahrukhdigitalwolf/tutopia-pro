...
function IndustryMoniterCards() {
  return (
    <div className="text-center max-w-full w-[250px] mx-auto">
        ...
        <div>
            <h5 className="text-[20px] text-white font-medium mt-2 bg-gradient-to-r from-[#7BFEDE] to-[#94ff00] [background-clip:text] [-webkit-text-fill-color:transparent]">Porro Quisquam</h5>
